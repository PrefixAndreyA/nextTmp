...
// The code is almost identical to the dynamic page files
...
const Home = (props) => {
    ...
    return (
        <PageContent
            ...
            allPostsData={props.posts}
            allDevelopmentsData={props.developments}
            //forms={props.forms}
...
export async function getStaticProps({ preview }) {
    ...
    const pageData = preview
        ? await wp.getPreviewPages(pages, frontPageID, "pages")
        : pages;
